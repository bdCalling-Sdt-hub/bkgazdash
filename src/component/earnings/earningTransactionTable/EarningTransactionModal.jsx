            ...
            {selectedTransaction && (
                <div className='' id="print-section">
                    <p className="transaction-detail">
                        <strong>Transaction ID:</strong> {selectedTransaction?.transitionId}
                    </p>
                    <p className="transaction-detail">
                        <strong>Date:</strong> {selectedTransaction?.createdAt?.split("T")[0] ? selectedTransaction?.createdAt?.split("T")[0] : "N/A"}
                    </p>
                    <p className="transaction-detail">
                        <strong>User name:</strong> {selectedTransaction?.userId?.fullName}
                    </p>
                    <p className="transaction-detail">
                    ...
                    <p className="transaction-detail">
                        <strong>Transaction amount:</strong> {selectedTransaction?.userId?.totalCashBalance}
                    </p>
                </div>
            )}
        </AntdModal>
