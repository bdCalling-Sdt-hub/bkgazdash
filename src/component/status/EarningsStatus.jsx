        ...
        <div className="grid grid-cols-3 gap-12 w-[79vw] mt-[12px]">
            <div className="bg-[#E8EBF0] px-[20px] py-[32px] flex justify-between items-center rounded-lg ">
                ...
                <div className="">
                    ...
                    <h1 className="text-secondary text-[44px]">${ earnStatus?.data?.attributes?.totalEarnings}</h1>
                </div>
            </div>
            <div className="bg-[#E8EBF0] px-[20px] py-[32px] flex justify-between items-center rounded-lg ">
                ...
                <div className="">
                    ...
                    <h1 className="text-secondary text-[44px]">${data?.data?.attributes?.allUsers || 343}</h1>
                </div>
            </div>
            <div className="bg-[#E8EBF0] px-[20px] py-[32px] flex justify-between items-center rounded-lg">
                ...
                <div className=" ">
                    ...
                    <h1 className="text-secondary text-[44px]">{data?.data?.attributes?.paidUsers || 43}</h1>
                </div>
            </div>
